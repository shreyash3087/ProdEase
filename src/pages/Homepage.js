            ...
            <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="bg-gray-100 p-8 rounded-lg shadow-lg">
                ...
                <p className="text-gray-600">
                  View and manage all product information from a single
                  dashboard. Admins can also create new products effortlessly.
                </p>
              </div>
              <div className="bg-gray-100 p-8 rounded-lg shadow-lg">
                <h3 className="text-xl font-semibold text-gray-800 mb-3">
              ...
              <div className="bg-gray-100 p-8 rounded-lg shadow-lg">
                ...
                <p className="text-gray-600">
                  Monitor your submissions as a membeer and pending requests as
                  an admin in your profile
                </p>
              </div>
            </div>
            <div className="mt-12">
